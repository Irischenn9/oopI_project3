...
public class A1083359_Project3_Environment
{
    ...
    private ArrayList<A1083359_Project3_Card> path;
    // All the removed hazards so far. 
    private ArrayList<A1083359_Project3_Hazard> occurredHazards;
    ...
    public A1083359_Project3_Environment()
    {
    }
    ...
    public void setPath(ArrayList<A1083359_Project3_Card> path)
    {
        this.path = new ArrayList<>(path);
    }

    public void setOccurredHazards(ArrayList<A1083359_Project3_Hazard> occurredHazards)
    {
        this.occurredHazards = new ArrayList<>(occurredHazards);
    }

    public String generateFile(A1083359_Project3_Agent agent) throws IOException
    {
        ...
        for (A1083359_Project3_Artifact artifact : agent.getOwnedArtifacts())
